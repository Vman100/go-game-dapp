...
whenEnvIsLoaded(function () {
  EmbarkJS.Names.setProvider('ens', {
    ...
    "registryAddress": "0xEDA15494702cb7D5E55db8494264A306965d1E5A",
    "registrarAbi": [{
      "constant": false,
      "inputs": [{
        "name": "subnode",
    ...
    "registrarAddress": "0x700442d08669914b1Ce6D877cDE9121F37Ae52Ed",
    "resolverAbi": [{
      "constant": false,
      "inputs": [{
        "name": "node",
    ...
    "resolverAddress": "0xfE3e5171c3405b512A4da43EEd78459a638E52a2"
  });
});
"use strict";
